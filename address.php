...
if(array_key_exists("continue",$_POST) && isset($_POST['continue'])){
	$query = "INSERT INTO address (userid,firstname,pincode,email,number,address,landmark) VALUES ('".$_SESSION['id']."','".$_POST['firstname']."','".$_POST['pincode']."','".$_POST['email']."','".$_POST['number']."','".$_POST['address']."','".$_POST['landmark']."')";
	...
	<div class="form-style-10 " style="margin-top:100px;width:60%">
		...
		<form method="post">
			...
			<div class="inner-wrap">
				<label>Your Full Name <input type="text" name="firstname" required></label>
			...
			<div class="inner-wrap">
				...
				<label>Phone Number <input type="text" name="number" required></label>
			</div>

			<div class="section"><span>3</span>Address Details</div>
				<div class="inner-wrap">
				<label>Complete Address <input type="text" name="address" required></label>
				<label>Any Landmark(Optional) <input type="text" name="landmark" /></label>
			</div>
